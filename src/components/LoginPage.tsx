      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md mx-auto lg:mx-0">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-3" style={{ backgroundColor: '#E9F2FF' }}>
              <span className="text-2xl" style={{ color: '#007BFF' }}>📚</span>
            </div>
            <h2 className="text-blue-600 mb-1" style={{ color: '#007BFF' }}>ApplyBro</h2>
            <p className="text-sm text-gray-600">Empowering Students with Opportunities</p>
          </div>

          <h1 className="text-center mb-1 text-2xl font-semibold">Login</h1>
          <p className="text-center text-sm text-gray-500 mb-2">Welcome back 👋</p>
        ...
        <div className="hidden lg:flex flex-col justify-center items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-xl shadow-lg border-2 border-blue-100">
              <p className="text-sm">
                <span className="text-blue-600">🎓 10,000+</span> students already registered
              </p>
            </div>
          </div>
        </div>
